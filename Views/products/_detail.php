        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price"><?=number_format($product['price']).' vnđ' ?? 'Liên hệ'?></div>
                    ...
                    <form action="index.php?controller=cart&action=store&id_product=<?= $product['id'] ?>" method="post">
                        ...
                        <button class="primary-btn">Thêm vào giỏ</button>
        ...
        <div class="container">
            ...
            <div class="row">
                <?php if ($products) { ?>
                    ...
                    <?php }?>
                <?php   } else { ?>
                    <p algin="center">Không có sản phẩm liên quan</p>
                <?php } ?>
            </div>
        </div>
    </section>
